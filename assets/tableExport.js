  ...
  $.fn.tableExport = function (options) {
    ...
    if (defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt') {
      ...
      saveToFile(xlsxWorkbookToArrayBuffer(wbData),
        ...
        'UTF-8', '', false);
    } else if (defaults.type === 'excel' || defaults.type === 'xlsx' || defaults.type === 'word' || defaults.type === 'doc') {

      const MSDocType = (defaults.type === 'excel' || defaults.type === 'xlsx') ? 'excel' : 'word';
      const MSDocExt = (MSDocType === 'excel') ? 'xlsx' : 'doc';
